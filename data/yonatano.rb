...
entry!('krizhevsky2011verydeep',
       title('Using Very Deep Autoencoders for Content-Based Image Retrieval'),
       author('Alex Krizhevsky and Geoffrey E. Hinton'),
       inproceedings('19th European Symposium on Artificial Neural Networks, Computational Intelligence and Machine Learning (ESANN)', 2011),
       pages(489, 494),
       nil)
...
entry!('feng2014cross',
       ...
       inproceedings('Proceedings of the 22Nd ACM International Conference on Multimedia', 2014),
       pages(7, 16),
       nil)

entry!('zhou2016community',
       ...
       article('Knowledge-Based Systems', 2016),
       pages(75, 83),
       nil)

entry!('grover2017unfolding',
...
entry!('clinchant2013aggregating',
