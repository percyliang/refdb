...
entry!('joglekar2015comprehensive',
  inproceedings('Data Engineering (ICDE), 2015 IEEE 31st International Conference on', 2015),
...
entry!('craven1999constructing',
  inproceedings('ISMB', 1999),
...
entry!('varma2017socratic',
  arxiv(2017, '1610.08123'),
...
entry!('de2016deepdive',
  article('ACM SIGMOD Record', 2016, 45),
...
entry!('wu2018fonduer',
  inproceedings('Proceedings of SIGMOD 2018', 2018),
...
entry!('mann2010generalized',
  article('Journal of machine learning research', 2010, 11),
...
entry!('younger1967recognition',
  article('Information and control', 1967, 10),
...
entry!('corney2016million',
  inproceedings('NewsIR@ ECIR', 2016),
...
entry!('li2016learning',
  arxiv(2016, '1612.04936'),
...
entry!('andreas2017learning',
  arxiv(2017, '1711.00482'),
...
entry!('krening2017learning',
  article('IEEE Transactions on Cognitive and Developmental Systems', 2017, 9),
...
entry!('grechkin2017ezlearn',
  arxiv(2017, '1709.08600'),
...
entry!('shuster2018imagechat',
  arxiv(2018, '1811.00945'),
...
entry!('luo2018learning',
  arxiv(2018, '1811.04604'),
...
entry!('rashkin2018know',
  arxiv(2018, '1811.00207'),
...
entry!('wang2018questions',
  arxiv(2018, '1805.04843'),
...
entry!('rao2018learning',
  arxiv(2018, '1805.04655'),
...
entry!('zhang2018interactive',
  arxiv(2018, '1805.00462'),
...
entry!('mccann2018natural',
  arxiv(2018, '1806.08730'),
  title('The natural language decathlon: Multitask learning as question answering'),
  author('Bryan McCann and Nitish Shirish Keskar and Caiming Xiong and Richard Socher'),
nil)

entry!('conneau2018senteval',
  arxiv(2018, '1803.05449'),
  title('SentEval: An Evaluation Toolkit for Universal Sentence Representations'),
  author('Alexis Conneau and Douwe Kiela'),
nil)

entry!('sanh2018hierarchical',
  arxiv(2018, '1811.06031'),
  title('A Hierarchical Multi-task Approach for Learning Embeddings from Semantic Tasks'),
  author('Victor Sanh and Thomas Wolf and Sebastian Ruder'),
nil)

entry!('werts1995instructive',
  article('Journal of Behavioral Education', 1995, 5),
...
entry!('tong2001support',
  article('Journal of machine learning research', 2001, 2),
...
entry!('schmidhuber1991learning',
  article('International Journal of Neural Systems', 1991, 2),
...
entry!('schatzmann2006survey',
  article('The knowledge engineering review', 2006, 21),
...
entry!('serban2017deep',
  arxiv(2017, '1709.02349'),
...
entry!('bassiri2011interactional',
  article('English Language and Literature Studies', 2011, 1),
...
entry!('kruger1999unskilled',
  article('Journal of personality and social psychology', 1999, 77),
...
entry!('radford2018improving',
  techreport('OpenAI', 2018),
  title('Improving language understanding by generative pre-training'),
  author('Alec Radford and Karthik Narasimhan and Tim Salimans and Ilya Sutskever'),
nil)

entry!('rieser2011reinforcement',
  article('Springer Science \& Business Media', 2011),
...
entry!('ross2009turkers',
  techreport('Department of Informatics, University of California, Irvine', 2009),
