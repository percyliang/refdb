entry!('levesque2013best',
  author('Hector J. Levesque'),
  title('On our best behaviour'),
  ijcai(2013),
nil)

entry!('szegedy2014intriguing',
...
entry!('papernot2017blackbox',
  ...
  inproceedings('Proceedings of the ACM Asia Conference on Computer and Communications Security', 2017),
...
entry!('paice1990lancaster',
  ...
  inproceedings('ACM SIGIR Forum', 1990),
nil)
...
entry!('smith2012adversarial',
  author('Noah A. Smith'),
  title('Adversarial Evaluation for Models of Natural Language'),
  arxiv(2012, '1207.0245'),
nil)

entry!('bowman2016continuous',
