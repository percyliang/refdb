entry!('papernot2016limitations',
  inproceedings('Security and Privacy (EuroS\&P), 2016 IEEE European Symposium on', 2016),
...
entry!('tramer2017ensemble',
  arxiv(2017, '1705.07204'),
...
entry!('brendel2017comment',
  arxiv(2017, '1704.01547'),
...
entry!('papernot2017extending',
  arxiv(2017, '1705.05264'),
  title('Extending Defensive Distillation'),
  author('Nicolas Papernot and Patrick McDaniel'),
nil)

entry!('shaham2015understanding',
  arxiv(2015, '1511.05432'),
...
entry!('pang2017robust',
  arxiv(2017, '1706.00633'),
...
entry!('grosse2017statistical',
  arxiv(2017, '1702.06280'),
...
entry!('anguita2013har',
  inproceedings('21st European Symposium on Artificial Neural Networks, Computational Intelligence and Machine Learning (ESANN)', 2013),
