...
entry!('zhu2019text',
       ...
       arxiv(2019, '1901.00158'),
       )

entry!('ippolito2019unsupervised',
       ...
       inproceedings('NAACL Workshop on Narrative Understanding', 2019),
       pages(37,43),
       )
...
entry!('mansimov2019generalized',
       ...
       arxiv(2019, '1905.12790'),
       )

entry!('gu2019levenshtein',
       author('Jiatao Gu and Changhan Wang and Jake Zhao'),
       title('Levenshtein Transformer'),
       arxiv(2019, '1905.11006'),
       )

entry!('joshi2019spanbert',
