...
entry!('silver2016mastering',
  ...
  article('Nature', 2016, 529),
  number(7587),
  pages(484, 489),
  publisher('Nature Publishing Group'),
)

entry!('silver2017mastering',
...
entry!('sutton1999between',
  title('Between MDPs and semi-MDPs: A framework for temporal abstraction in reinforcement learning'),
  author('R. S. Sutton and D. Precup and S. Singh'),
  article('Articial intelligence', 1999, 112),
  pages(181, 211),
  publisher('Elsevier'),
)
...
# Outdated Cite --> Change to ICML 2017
