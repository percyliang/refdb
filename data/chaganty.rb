...
entry!('kalyanpur2012structured',
  ...
  article('{IBM} Journal of Research and Development', 2012, 56), pages(351,364),
  title('Structured data and inference in DeepQA'),
  url('http://ieeexplore.ieee.org/xpls/abs{\_}all.jsp?arnumber=6177725'),
nil)
entry!('lee2015conversational',
  ...
  article('16th Annual Meeting of the Special Interest Group on Discourse and Dialogue', 2015), pages(139, 143),
nil)

entry!('han2015exploiting',
  ...
  article('16th Annual Meeting of the Special Interest Group on Discourse and Dialogue', 2015), pages(129, 133),
nil)
...
entry!('yilmaz2008simple',
  ...
  url('http://dl.acm.org/citation.cfm?id=1390437'),
  sigir('2008'),
nil)

entry!('vannella2014validating',
  ...
  url('http://wwwusers.di.uniroma1.it/~navigli/pubs/ACL_2014_Vannellaetal.pdf'),
  acl('2014'),
nil)

entry!('pavlick2016gun',
