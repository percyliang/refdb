...
entry!('cohen2019certified',
       icml(2019),
  title('Certified adversarial robustness via randomized smoothing'),
  author('Jeremy M Cohen and Elan Rosenfeld and J Zico Kolter'),
nil)

entry!('rosenberg2005semi',
 inproceedings('Proceedings of the Seventh IEEE Workshops on Application of
...
entry!('devries2017improved',
  arxiv(2017, '1708.04552'),
  title('Improved regularization of convolutional neural networks with cutout'),
  author('Terrance DeVries and Graham W Taylor'),
nil)

entry!('torralba2008million',
  article('IEEE transactions on pattern analysis and machine intelligence', 2008, 30),
...
entry!('zagoruyko2016wide',
  inproceedings('British Machine Vision Conference', 2016),
...
entry!('xie2019unsupervised',
  arxiv(2019, '1904.12848'),
...
entry!('montasser2019vc',
  arxiv(2019, '1902.04217'),
