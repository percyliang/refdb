...
entry!('meyer2014semantic',
  article('Science', 2014, 345),
  title('Semantic priming well established'),
...
entry!('weidinger2021ethical',
  arxiv(2021, '2112.04359'),
...
entry!('bender2021stochastic',
  facct(2021),
  title('On the Dangers of Stochastic Parrots: Can Language Models Be Too Big?'),
  author('Emily Bender and Timnit Gebru and Angelina McMillan-Major and Shmargaret Shmitchel'),
  )

entry!('carlini2020extracting',
  arxiv(2020, '2012.07805'),
...
entry!('blodgett2021stereotyping',
  acl(2021),
...
entry!('lin2021truthful',
  arxiv(2021, '2109.07958'),
  title('TruthfulQA: Measuring How Models Mimic Human Falsehoods'),
  author('Stephanie Lin and Jacob Hilton and Owain Evans'),
  )

entry!('cobbe2021training',
  arxiv(2021, '2110.14168'),
  title('Training Verifiers to Solve Math Word Problems'),
  author('Karl Cobbe and Vineet Kosaraju and Mohammad Bavarian and Mark Chen and Heewoo Jun and Lukasz Kaiser and Matthias Plappert and Jerry Tworek and Jacob Hilton and Reiichiro Nakano and Christopher Hesse and John Schulman'),
  )

entry!('hendrycks2021math',
  neurips(2021),
  title('Measuring Mathematical Problem Solving With the {MATH} Dataset'),
  author("Dan Hendrycks and Collin Burns and Saurav Kadavath and Akul Arora and Steven Basart and Eric Tang and Dawn Song and Jacob Steinhardt"),
  )

entry!('tang2021solving',
  arxiv(2021, '2111.08276'),
...
entry!('ram2018conversational',
  arxiv(2018, '1801.03604'),
...
entry!('ziegler2019fine',
  arxiv(2019, '1909.08593'),
...
entry!('strack1988priming',
  article('European Journal of Social Psychology', 1988, 18),
  title('Priming and communication: Social determinants of information use in judgments of life satisfaction'),
  author('Fritz Strack and Leonard L. Martin and Nobert Schwarz'),
  number(5),
  pages(429, 442),
  publisher('John Wiley \& Sons'),
  )

entry!('kahneman2002representativeness',
  ...
  incollection('Heuristics and Biases: The Psychology of Intuitive Judgement', 2002),
  editor('Thomas Gilovich and Dale Griffin and Daniel Kahneman'),
  pages(49, 81),
  publisher('Cambridge University Press'), address('Cambridge'),
  )

entry!('tversky1973availability',
  article('Cognitive Psychology', 1973, 5),
...
entry!('windhager2010laying',
  article('Collegium Antropologicum', 2010, 34),
  title('Laying eyes on Headlights: Eye Movements Suggest Facial Features in Cars'),
  author('Sonja Windhager and Florian Hutzler and Claus-Christian Carbon and Elisabeth Oberzaucher and Katrin Schaefer and Truls Thorstensen and Helmut Leder and Karl Grammer'),
  number(3),
  pages(1075,1080),
  publisher('Croatian Anthropological Society')
)

entry!('tversky1974judgement',
  article('Science', 1974, 185),
...
entry!('jacowitz1995anchoring',
  article('Personality and Social Psychology Bulletin', 1995, 21),
...
entry!('tversky1981framing',
  article('Science', 1981, 211),
