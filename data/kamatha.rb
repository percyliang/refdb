...
entry!('zhang2019molecular',
  ...
  article('CoRR', 2019, 'abs/1902.00925'),
  url('http://arxiv.org/abs/1902.00925'),
nil)

entry!('varshney2011risk',
  inproceedings('2011 IEEE Statistical Signal Processing Workshop (SSP)', 2011),
  author('K. R. Varshney'),
  title('A risk bound for ensemble classification with a reject option'),
nil)

entry!('geifman2019selectivenet',
  author('Yonatan Geifman and Ran El-Yaniv'),
  title('SelectiveNet: A Deep Neural Network with an Integrated Reject Option'),
  icml(2019),
nil)

entry!('khan2001diagnosis',
...
entry!('kahn2017uncertaintyaware',
